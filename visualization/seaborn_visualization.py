"""
This module generates a packed bubble chart using Matplotlib and Seaborn to visualize
the 'Hidden Gem' index for various cities. It exports the result as a PNG image.
"""
import matplotlib
...
from final_data_version import coordinates

# Created a sorted list of unique country names from the data (index 5 is Country)
unique_countries = sorted({item[5] for item in coordinates})
...
for (x, y, r, city_name, score, country) in coordinates:
    ...
    # Create the Circle object with the color 'color' and black border
...
# The custom Legend: here since we used 'add_patch' the legend isn't auto generated
...
# Broken into multiple lines to satisfy line length limits
ax.legend(
...
plt.savefig('Result.png') # Save directly to file
